...
J.make_launch_script(train, a="hey", b=[0, 1, 2], log_dir=LOG_DIR, no_sudo=True, verbose=True,
...
J.launch_and_run(region="us-west-2", image_id="ami-bd4fd7c5", instance_type="p2.xlarge", key_name="ge-berkeley",
                 security_group="torch-gym-prebuilt", is_spot_instance=True, spot_price=0.4,
